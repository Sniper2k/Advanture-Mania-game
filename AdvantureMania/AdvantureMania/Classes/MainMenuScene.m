...
- (id)init
{
    ...
    CCButton *Button = [CCButton buttonWithTitle:@"[ Select ]" fontName:@"Verdana-Bold" fontSize:18.0f];
    Button.positionType = CCPositionTypeNormalized;
    Button.position = ccp(0.5f, 0.50f);
    [Button setTarget:self selector:@selector(selectButton:)];
...
- (void)onSpinningClicked:(id)sender
{
    ...
    //Unit* en = [[Unit alloc] init];
    
    // start spinning scene with transition
    [[CCDirector sharedDirector] replaceScene:[DeckBuilderScene sceneWithDeckIndex:0]
